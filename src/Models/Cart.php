...
class Cart extends RestModel
{
     ...
     * Paypal offre la possibilità di eseguire il pagamento diretto o con prelievo automatico in un momento successivo
     * ($preapproval=true). Nell'ultimo caso  se l'utente non ha mai fornito l'autorizzazione ai prelievi automatici
     * l'api fornisce un intent per fare la redirect a paypal, altrimenti fornisce direttamente il carrello creato.
     *
    ...
    /**
     * Questa chiamata va eseguita una volta che è stato effettuato il pagamento con paypal e per forzare l'api a fare
     * il checkout finale.
     * @param $preApproval
     * @param string $mode
     * @return bool|mixed
    ...
    public function setShippingAddress()
    {
        if ($this->id != null)
        {
            ...
            throw new \Exception("cart_id is not defined");
    }
